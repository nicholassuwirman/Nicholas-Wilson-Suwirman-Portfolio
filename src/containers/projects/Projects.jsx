...
const Project = () => {
  return (
    <div className="projects-container" id="projects">
      ...
      description={"I worked on the DreamBridge team to develop their website, which integrated Scenario API to later support master students in the media department. Dreambridge will let them generate images, videos, and also train their own AI model (Work in progress)"} 
